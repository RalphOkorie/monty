...
#include <ctype.h>
/**
 * struct stack_s - It doubly linked list representation of a stack (or queue)
 * @n: integer
...
/**
 * struct bus_s - It variables -args, file, line content
 * @arg: value
...
extern bus_t bus;
/**
 * struct instruction_s - This is opcode and its function
 * @opcode: the opcode
